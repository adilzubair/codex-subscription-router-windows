...
import (
	...
	"github.com/adilzubair/codex-subscription-router-windows/internal/control"
	"github.com/adilzubair/codex-subscription-router-windows/internal/mux"
	"github.com/adilzubair/codex-subscription-router-windows/internal/protocol"
...
func loadOrCreateToken(root string) (string, error) {
	...
	if data, err := os.ReadFile(path); err == nil {
		...
		if chmodErr := securefs.Restrict(path, false); chmodErr != nil {
	...
	if err := securefs.Restrict(path, false); err != nil {
